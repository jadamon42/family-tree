...
function TreeSegment({ data, people, partnerships, treePathIds, onPersonLeftClick, onPersonRightClick, onPartnershipLeftClick, onPartnershipRightClick }: TreeSegmentProps) {
  return (
    <div>
      <PartnershipChain
        data={data}
